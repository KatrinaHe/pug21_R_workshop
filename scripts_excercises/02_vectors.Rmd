...
```{r}
Char_vector <- c("Kuchen", "Keks", "Apfel")
Char_vector

num_vector <- c(1,7,4,5,6,7,8,3,9,21)
num_vector

dec_vector <- c(1.2, 2.5, 3.3, 5.54)
dec_vector

logic_vector <- c(TRUE, FALSE, FALSE, TRUE, TRUE)
logic_vector
...
it gives the first six and the last six values
...
sd(vector_na,na.rm = TRUE)

min(vector_na,na.rm = TRUE)
max(vector_na,na.rm = TRUE)

summary(vector_na, na.rm = TRUE)

table(vector_na, na.rm = TRUE)

head(vector_na, na.rm = TRUE)
tail(vector_na, na.rm = TRUE)

length(vector_na, na.rm = TRUE)
