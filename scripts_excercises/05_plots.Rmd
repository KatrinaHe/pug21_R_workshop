...
nerd_red %>% 
  ...
  geom_point() + 
  geom_smooth(method = "lm", se = FALSE) +
  labs(y = "nerd score", title = "Nerd Diagram")
```
...
nerd_red %>% 
  ...
  scale_x_continuous(breaks = seq(10, 100, 10), limits = c(10, 90)) +
  scale_y_continuous(breaks = seq(10, 130, 20), limits = c(0, 130)) +
...
nerd_red %>% 
  ...
  theme_bw()
#fill is the bars, colour is the outline
...
nerd_red %>% 
  ...
  geom_boxplot() + 
  scale_fill_manual("did people vote", values = c("pink", "dark blue"))+
 
  scale_y_continuous(breaks = seq(10, 150, 20), limits = c(0, 150)) +
  
  labs(y = "Nerd Score", title = "Nerd Score by Gender & Vote")+
  theme_bw() + 
  theme(legend.position = "top")
```
